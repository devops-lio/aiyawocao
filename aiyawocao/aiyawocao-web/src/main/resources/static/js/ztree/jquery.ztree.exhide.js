...
(function ($) {
  ...
  var _initNode = function (setting, level, n, parentNode, isFirstNode,
      isLastNode, openFlag) {
      ...
      _view = {
        ...
        makeDOMNodeMainBefore: function (html, setting, node) {
          ...
          html.push("<li ", (isHidden ? "style='display:none;' " : ""), "id='",
              node.tId, "' class='", consts.className.LEVEL, node.level,
        ...
        showNodes: function (setting, nodes, options) {
          ...
          for (i = 0, j = nodes.length; i < j; i++) {
            ...
            if (!pList[n.parentTId]) {
              ...
              pList[n.parentTId] = (pn === null) ? data.getRoot(setting)
                  : n.getParentNode();
            }
...
//	Override method in core
  ...
  data.initNode = function (setting, level, node, parentNode, isFirstNode,
      isLastNode, openFlag) {
  ...
  if (!!_expandCollapseSonNode) {
    view.expandCollapseSonNode = function (setting, node, expandFlag,

 ...
 */
public class App {
  public static void main(String[] args) throws SocketException, InterruptedException, DecoderException,
...
//            add("7b1e58d398e808d6242d8e1cd4c91ffe02539cbb 79.115.170.168:58759");
  ...
  public static void testFetcher() {
    try {
      ...
      BencodedString infohash = new BencodedString(Hex.decodeHex("1465bb33acf81c2725eb62fb14a4e206d5af6a69"
          .toCharArray()));

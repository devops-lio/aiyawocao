...
cat ./aiyawocao/metadata-service-server/src/main/service/metadata_service.service | sed s:start_bash_path:$start_metadata_service_bash:g | sed s:stop_bash_path:$stop_metadata_service_bash:g > ./crawler_deploy/service/metadata_service.service

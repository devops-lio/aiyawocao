...
start_metadata_service_bash=$(cd "$(dirname "$0")";cd ..;pwd)/metadata_service_deploy/bin/start_metadata_service.sh
stop_metadata_service_bash=$(cd "$(dirname "$0")";cd ..;pwd)/metadata_service_deploy/bin/stop_metadata_service.sh
